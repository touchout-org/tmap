...
* **"Distance and Scale" heading**:
    ...
    * Scale: implemented, the same 9 presets as always (1 in = 100, 200, 300, [400], 500, 1000, 1500, 2000, 5000 ft), moved here from a standalone combo box next to the H2 in Screen Layout. Live-apply, same as every other control in this dialog.
